...
dat_bakers = read_csv("./data/gbb_datasets/bakers.csv") |> 
  janitor::clean_names() |> 
  separate(
    baker_name, 
...
write_csv(dat_merge_f, "./data/gbb_datasets/merge_data.csv")
```
...
```{r}
dat_viewers = read_csv("./data/gbb_datasets/viewers.csv") |> 
  janitor::clean_names()
